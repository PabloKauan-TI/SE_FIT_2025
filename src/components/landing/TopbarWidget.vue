...
<template>
    <a class="flex items-center" href="#">
        <img src="/logo_fit_p.svg" alt="Logo FIT" class="h-10 mr-3" />

        <span class="text-surface-900 dark:text-surface-0 font-medium text-2xl leading-normal mr-20 whitespace-nowrap">FIT - Fórum de Inovação e Tecnologia</span>
    </a>
    ...
    <div class="items-center bg-surface-0 dark:bg-surface-900 grow justify-between hidden lg:flex absolute lg:static w-full left-0 top-full px-12 lg:px-0 z-20 rounded-border">
        ...
        <div class="flex border-t lg:border-t-0 border-surface py-4 lg:py-0 mt-4 lg:mt-0 gap-2">
            ...
            <Button label="Cadastre-se" as="router-link" to="/pages/cadastrar-usuario" rounded></Button>
        </div>
    </div>
</template>
